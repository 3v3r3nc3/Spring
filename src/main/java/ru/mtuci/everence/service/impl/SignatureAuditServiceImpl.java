...
public class SignatureAuditServiceImpl {
    ...
    public void createSignatureAudit(UUID signatureId, Long userId, String changedType, Date changedAt, String fieldChanged) {
        ApplicationSignatureAudit audit = createAudit(signatureId, userId, changedType, changedAt, fieldChanged);
        repository.save(audit);
    }

    private ApplicationSignatureAudit createAudit(UUID signatureId, Long userId, String changedType, Date changedAt, String fieldChanged) {
